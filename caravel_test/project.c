...
void main()
{
	...
	PWM_DRIVE_SETUP = 
		PWM_BREAK_BEFORE_MAKE(3,0) | PWM_PRESCALER(3,0) |
		PWM_BREAK_BEFORE_MAKE(2,0) | PWM_PRESCALER(2,0) |
		PWM_BREAK_BEFORE_MAKE(1,0) | PWM_PRESCALER(1,0) |
		PWM_BREAK_BEFORE_MAKE(0,0) | PWM_PRESCALER(0,0);
	
	PWM_DRIVE_PWM = PWM(3,0xFF) | PWM(2,0xFE) | PWM(1,0x01) | PWM(0,0x00);
